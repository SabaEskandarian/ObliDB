...
Together, these contributions make \name/ the first system to support---and achieve acceptable performance on---both transactional and analytics workloads.
...
It also provides a query optimizer to automatically select the best operator implementations for a query at runtime.
