...
On analytics workloads, \name/ ranges from competitive to 19$\times$ faster than systems designed \emph{only} for analytics, such as Opaque.
...
%Each database table may be represented in one or both ways.
...
\begin{figure}
\centering
\includegraphics[width=.9\linewidth]{figure_revised.pdf}
...
\addplot %opaque obliv
	coordinates {(BDB Q1,1.54659) (BDB Q2,3.210607) (BDB Q3,17.26355) (4, 1)};
\addplot %us
	coordinates {(BDB Q1,2.434) (BDB Q2, 3.0422) (BDB Q3,12.774) (4,1)};
%\addplot %spark sql
...
\coordinate (A) at (axis cs:BDB Q1,.11755);
\coordinate (B) at (axis cs:BDB Q2,.11755);
\coordinate (C) at (axis cs:BDB Q2,1.2848);
\coordinate (D) at (axis cs:BDB Q3,1.2848);
\coordinate (E) at (axis cs:BDB Q3,4.8357);
...
\addplot %opaque obliv
	coordinates {(BDB Q1,1.54659) (BDB Q2,3.210607) (BDB Q3,17.26355) (4, 1)};
\addplot %us
	coordinates {(BDB Q1,.0824) (BDB Q2, 3.0422) (BDB Q3,12.774) (4,1)};
%\addplot %spark sql
%	coordinates {(BDB Q1,.1615) (BDB Q2,1.9757) (BDB Q3,7.2477) (4,1)};
    %\legend{Opaque Oblivious Mode,\name/, Spark SQL (No Security)}
...
\coordinate (E) at (axis cs:BDB Q3,4.8357);
\coordinate (F) at (axis cs:4,4.8357);
%\coordinate (G) at (axis cs:BDB Q1,2.434);
%\coordinate (H) at (axis cs:BDB Q2,2.434);
...
\end{semilogyaxis}
\end{tikzpicture}
\caption{\small \name/ outperforms Opaque Oblivious~\cite{ZDB+17} by 1.1-18.8$\times$ and never runs more than 2.6$\times$ slower than Spark SQL~\cite{SparkSQL} on the Q1-Q3 of the Big Data Benchmark~\cite{BDB}. Even without use of an index, \name/ performs comparably to Opaque Oblivious.}
\label{figOpaque}
\end{figure}
...
\addplot
	coordinates {(Insert,.00001) (Delete,.70634) (Update,.71077) (4, 1)};
\addplot
	coordinates {(Insert,.00424) (Delete,.00593) (Update,.00268) (4,1)};
    \legend{Linear, Indexed}
\end{semilogyaxis}
\end{tikzpicture}\\
\end{tabular}
...
\begin{axis}[
	...
	ybar interval=.7,
	ylabel={Time [seconds]},
    title={Effective Table Types for Different Workloads},
	symbolic x coords={Load 1, Load 2, Load 3, Load 4, Load 5, 4},
	legend style={at={(0.5,-.13)},
...
\addplot
	coordinates {(Load 1, 6.944) (Load 2, 61.670) (Load 3, 70.22698) (Load 4, 66.711) (Load 5, 67.27659) (4,1)};
\addplot
	coordinates {(Load 1, 14.122) (Load 2, 2.6639) (Load 3, 137.851) (Load 4, 124.121) (Load 5, 245.3216) (4,1)};
\addplot[color=violet, fill=violet]
	coordinates {(Load 1, 3.962) (Load 2, 3.36899) (Load 3, 36.165) (Load 4, 36.132) (Load 5, 67.3285) (4,1)};


\legend{Linear, Indexed, Combined}
\end{axis}
\end{tikzpicture}
\caption{\small Linear, Indexed, and combined representations of data performing on various workloads over a 100,000 row table.}
\label{figworkloadgraph}
\end{figure}
...
\centering
\begin{tabular}{ll}
\textbf{Workload} & \textbf{Queries} \\\hline\rule{0pt}{2.5ex}
1: Logging & 90 Insertions\\
 & 5 Point Reads \\
  & 5 Large Reads \\\rule{0pt}{2.5ex}
2: Social Media & 90 Small Reads\\
 & 9 Insertions \\
  & 1 Deletion \\\rule{0pt}{2.5ex}
3: Balanced read-only & 50 Point Reads\\
  & 50 Large Reads \\\rule{0pt}{2.5ex}
4: Balanced, mostly reads & 45 Point Reads \\
  & 45 Large Reads\\
  & 5 Insertions\\
  & 5 Deletions\\\rule{0pt}{2.5ex}
5: Mostly large reads & 90 Large Reads \\
  & 5 Insertions\\
  & 5 Deletions\\
\end{tabular}
\caption{\small Workloads for evaluating comparative performance of table representations. Point reads access 1 record, small reads access 50 records, and large reads access 5\% of the table.}
\label{figworkloadtable}
\end{figure}
...
\legend{Hash, Small, Large, Cont.}
       \draw (37,95) node {\textasteriskcentered};
       \draw (77,900) node {* Our Choice}; 
       \draw (137,95) node {\textasteriskcentered};
       \draw (287,190) node {\textasteriskcentered};
       \draw (362.5,225) node {\textasteriskcentered};
       \draw (63,20) node {\tiny{N/A}};
       \draw (161,20) node {\tiny{N/A}};
       \draw (187,20) node {\tiny{N/A}};
       \draw (387,20) node {\tiny{N/A}};
