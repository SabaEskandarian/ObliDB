...
\caption{Comparison of \texttt{SELECT} algorithms on Linear table where 5 and 95 percent of a 100,000 row table are retrieved. The Small and Large strategies do well in the 5\% and 95\% cases, respectively, and the Continuous strategy always performs well when applicable.} 
\label{figC3}
\end{figure}
...
\end{tikzpicture}
\end{tabular}
\caption{Comparison between \name/ and a baseline solution where a B+ tree is generically ported to use ORAM on a table of 100,000 rows. \name/ outperforms the baseline for insertions and deletions by 3.6x and 3.1x, respectively, while performing slightly faster on updates.}
\label{figC2} 
\end{figure}
...
\begin{semilogyaxis}[
	...
	ylabel={Time [seconds]},
    title={Big Data Benchmark Comparison},
...
\addplot %baseline
	coordinates {(BDB Q1, 56.33) (BDB Q2, 225.03) (BDB Q3, 138.53) (4,1)};
\addplot %opaque obliv
	coordinates {(BDB Q1,2.2437) (BDB Q2,4.2908) (BDB Q3,19.9664) (4, 1)};
\addplot %us
	coordinates {(BDB Q1,.11178) (BDB Q2, 3.52) (BDB Q3,15.66) (4,1)};
\addplot %spark sql
	coordinates {(BDB Q1,.1615) (BDB Q2,1.9757) (BDB Q3,7.2477) (4,1)};
    \legend{Baseline, Opaque Oblivious, \name/, Spark SQL}
\end{semilogyaxis}
\end{tikzpicture}
