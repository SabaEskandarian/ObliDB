...
We also tested scan-based queries against the Indexed storage method. They performed about \textbf{2$\times$} slower than against linear tables, meaning that unlike prior, linear-only schemes, ObliDB performs reasonably on analytics for frequently updated tables. 
\begin{figure*}
\small
\centering
\begin{tabular}{@{}l@{}l@{}l}
