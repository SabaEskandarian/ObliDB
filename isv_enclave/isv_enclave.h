...
extern void bitonicSort(uint8_t* bothTables, int startIndex, int size, int flipped, int structureId1, int structureId2, int joinCol1, int joinCol2);
extern void bitonicMerge(uint8_t* bothtables, int startIndex, int size, int flipped, int structureId1, int structureId2, int joinCol1, int joinCol2);
