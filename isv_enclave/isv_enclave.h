...
extern void bitonicSort(uint8_t* bothTables, int startIndex, int size, int flipped);
extern void bitonicMerge(uint8_t* bothTables, int startIndex, int size, int flipped);
